...
% Adaptive Filtering of ECG - LMS filter
% Written by Galada Aditya
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [primary, refer, cancelled, step_size_optimal, snr_improvement_optimal,snr_improvement, mu_vec] = adaptive_lms_filter(input_ECG, input_noise_type, snratio)
    t = 1:250 * 60 * 2;
    ...
    parfor cc = 1:numel(mu_vec)
        ...
        [cancelled(cc,:)] = lms_za(primary, input, adap, mu, order);
