...
hr=[94,96,103,98,104,84,89,82,105,95,72,83,117,105,86,103,113,107,105,95,77,74,66,100,87,85,105,94,105,92,87];
...
%     errorbar(k,X0(k,5),X0(k,7),'Marker',Mk,'Color',Cl); hold on;    % IBI with standard derivation
   errorbar(k,X0(k,13),X0(k,14),'Marker','.','Color',Cl); hold on;    % HR with standard derivation
   plot(k,hr(k),'Marker','s','Color',Cl);
